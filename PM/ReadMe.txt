================================================================================
    MICROSOFT 基础类库 : PM 项目概述
===============================================================================

应用程序向导已为您创建了此 PM 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。

本文件概要介绍组成 PM 应用程序的每个文件的内容。
...
PMDlg.h、PMDlg.cpp - 对话框
    这些文件包含 CPMDlg 类。此类定义应用程序的主对话框的行为。对话框模板包含在 PM.rc 中，该文件可以在 Microsoft Visual C++ 中编辑。
...
StdAfx.h, StdAfx.cpp
    这些文件用于生成名为 PM.pch 的预编译头 (PCH) 文件和名为 StdAfx.obj 的预编译类型文件。
